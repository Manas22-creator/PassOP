...
const Navbar = () => {
  ...
  const openGitHub = () => {
    window.open("https://github.com/Manas22-creator", "_blank", "noopener,noreferrer");
  };
    ...
    <nav className="bg-blue-600 text-white">
      <div className="mycontainer flex flex-wrap justify-between items-center px-4 py-4 md:py-5">
        ...
        <div className="mt-3 md:mt-0">
          <button
            onClick={openGitHub}
            className="text-white bg-blue-500 rounded-full flex items-center gap-2 px-3 py-2 hover:bg-blue-800 border-2 border-blue-900 transition-all duration-200"
          >
            <img
              className="invert-0 p-1 w-8 h-8"
